    ...
    <div class="container pb-5">
        <div class="row">
            ...
            <div class="col-lg-7 mt-2">
                <div class="card">
                    <div class="card-body">
                        <p style="float: right">Chia sẻ :<a href="" onclick="shareOnFacebook()"
                                data-tooltip="Chia sẻ trên Facebook">
                                <i class="fab fa-facebook" style="color: #3173e6;"></i>
                            </a> <a href="" onclick="shareOnFacebook()" data-tooltip="Chia sẻ trên Facebook">
                                <i class="fab fa-google-plus" style="color: #d4200c;"></i>
                            </a> <a href="" onclick="shareOnFacebook()" data-tooltip="Chia sẻ trên Facebook">
                                <i class="fab fa-twitter-square" style="color: #3173e6;"></i>
                            </a>
                        </p>
                        ...
                        <p class="py-2">
                            <span class="list-inline-item text-dark">{{ $averageStars }}<i
                                    class="fa fa-star text-primary"></i> | {{ $commentCount }} Comments</span>
                        </p>
                        <p class="h4 py-1 text-danger">{{ number_format($priceByField[$field->id]['min'], 0, ',', '.') }} -
                            {{ number_format($priceByField[$field->id]['max'], 0, ',', '.') }}/giờ</p>
                    ...
                    <div class="row g-2">
                        <div class="col-md-3">
                            <div class="date" id="date1" data-target-input="nearest">
                                ...
                                <input type="date" name="order_date" class="col-md-14 form-control"
                                    min="<?php echo date('Y-m-d'); ?>"
                                    @if (session('orderDateFormatted')) value="{{ session('orderDateFormatted') }}"
                                @else
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="card border-0 shadow">
                        <div class="position-relative">
                            ...
                            @endif
                            <small
                                class="position-absolute start-0 top-100 translate-middle-y bg-primary text-white rounded py-1 px-3 ms-4">{{ $child->price }}/giờ</small>
                        </div>
                        <div class="card-body">
                        ...
                        <div class="row g-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <select id= "inputFieldChild"class="form-select" id="mySelect">
                                    @foreach ($fieldChilds as $child)
                                        <option>{{ $child->id }} - {{ $child->name_field_child }} -
                                            {{ $child->type_field_child }}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="col-md-6">
